...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "prcy-seeder\n"
...
static const string mainnet_seeds[] = {"seed.prcycoin.com", "seed1.prcycoin.com", "seed2.prcycoin.com", "seed3.prcycoin.com", "seed4.prcycoin.com", "seed5.prcycoin.com", ""};
static const string testnet_seeds[] = {""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("seed.prcycoin.com", 59682), true);
  }
  do {
